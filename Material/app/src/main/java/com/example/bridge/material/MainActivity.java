...
import com.example.bridge.material.tabs.SlidingTabLayout;
    ...
    NavUtils.navigateUpFromSameTask(this);
        ...
        if(id == R.id.navigate){
          ...
          Intent i = new Intent(this,nextactivity1.class);
            startActivity(i);
            overridePendingTransition(R.anim.abc_slide_in_bottom,R.anim.move);
        ...
        class MyPagerAdapter extends FragmentPagerAdapter {
            ...
            public Fragment getItem(int position) {
                MyFragment myFragment = MyFragment.getInstace(position);
                return myFragment;
            }
